        ...
        <DialogContent class="sm:max-w-[425px]">
            ...
            <div class="grid gap-4 py-4">
                ...
                <div class="flex gap-x-4 justify-end w-full">
                    <FormField v-slot="{ value, handleChange }" type="checkbox" name="is_pk">
                    ...
                    <FormField v-slot="{ value, handleChange }" type="checkbox" name="is_fk">
                        <FormItem class="flex flex-row items-start gap-x-3 space-y-0 ">
                            <FormControl>
                                <Checkbox :checked="value" @update:checked="handleChange"/>
                            </FormControl>
                    ...
                    <FormField v-slot="{ value, handleChange }" type="checkbox" name="is_null">
                        <FormItem class="flex flex-row items-start gap-x-3 space-y-0 ">
                            <FormControl>
                                <Checkbox :checked="value" @update:checked="handleChange"/>
                            </FormControl>
